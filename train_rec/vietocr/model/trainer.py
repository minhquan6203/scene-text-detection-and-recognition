...
class Trainer():
    def __init__(self, config, pretrained=True, augmentor=ImgAugTransform()):
        ...
        if pretrained == False:
            print("load weight")
            self.load_weights('/content/drive/MyDrive/train_rec/transformerorc_weights_last.pth')
    ...
    def train(self):
        ...
        for i in range(self.num_iters):
            ...
            if self.iter % self.save_every == 0:
              self.save_checkpoint('/content/drive/MyDrive/train_rec/transformerorc_checkpoint_last.pth')
              self.save_weights('/content/drive/MyDrive/train_rec/transformerorc_weights_last.pth')
